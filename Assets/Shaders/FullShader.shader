Shader "Custom/FullMapsURP_EmissiveFixed"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target {
                ...
                float3 eMap = SAMPLE_TEXTURE2D(_EmissionMap, sampler_EmissionMap, uvParallax).rgb;

                float3 emission = eMap * _EmissionColor.rgb * _EmissionStrength;
                ...
                float3 color = (ambient + diffuse + specularLight) * _Intensity + emission;
